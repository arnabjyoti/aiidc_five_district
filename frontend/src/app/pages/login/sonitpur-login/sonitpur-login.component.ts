...
@Component({
  selector: 'app-sonitpur-login',
  templateUrl: './sonitpur-login.component.html',
  styleUrls: ['./sonitpur-login.component.css']
})
export class SonitpurLoginComponent implements OnInit {
