...
@Component({
  selector: 'app-tinsukia-login',
  templateUrl: './tinsukia-login.component.html',
  styleUrls: ['./tinsukia-login.component.css']
})
export class TinsukiaLoginComponent implements OnInit {
