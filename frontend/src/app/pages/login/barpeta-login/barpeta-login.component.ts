...
@Component({
  selector: 'app-barpeta-login',
  templateUrl: './barpeta-login.component.html',
  styleUrls: ['./barpeta-login.component.css']
})
export class BarpetaLoginComponent implements OnInit {
